...
<body>
    ...
    <main>
        <div class="container py-5 vh-80">
            ...
            <div class="row h-100">
                ...
                <div class="col-md-5">
                    ...
                    <div class="d-grid gap-2">
                        <a class="btn btn-primary" href="${pageContext.request.contextPath}/ProductServlet?id=<%=item.getId()%>">Add to Cart</a>
                    </div>
                </div>
            </div>
        </div>
